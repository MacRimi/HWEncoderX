...
| `-e BOT_TOKEN` | Opcionalo si se desean notificaciones | El token de tu bot de Telegram para enviar notificaciones. |
| `-e CHAT_ID` | Opcionalo si se desean notificaciones | El ID del chat donde se enviarán las notificaciones de Telegram. |
