...
| `-e QUALITY` | Opcional | Define manualmente el nivel de calidad para la transcodificación, usado en NVENC, VAAPI y QSV. Si no se define se ajustara la calidad automatíceme |
